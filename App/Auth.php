...
use App\Model\RememberedLoginModel;
...
class Auth
{
    ...
    public static function login($user, $remember_me)
    {
        ...
        if ($remember_me) {
            $user->rememberLogin();
            setcookie('remember_me', $user->remember_token, $user->expiry_timestamp, '/', '', 1);
        }
    }
     ...
     * @param RememberedLoginModel $remembered_login The user model
     *
